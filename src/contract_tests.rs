...
-----END PGP PUBLIC KEY BLOCK-----";
    ...
    const CONTRACT_NAME: &str = "rxpnamer";
    ...
    fn subdomain_minting() {
        ...
        let parent_id_query_res: RXPnamerNftInfoResponse = from_binary(
            &entry::query(
                deps.as_ref(),
                mock_env(),
    ...
    fn alias_and_paths_cleared_on_send() {
        ...
        assert_eq!(
            ...
            StdError::NotFound {
                kind: "cw721_base::state::TokenInfo<rxpnamer::msg::Metadata>".to_string()
            }
        );
